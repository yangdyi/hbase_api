...
class Client(Iface):
  ...
  def send_append(self, table, append):
...
class Processor(Iface, TProcessor):
  ...
  def process_append(self, seqid, iprot, oprot):
    ...
    result = append_result()
    try:
      result.success = self._handler.append(args.table, args.append)
    except TIOError as io:
      result.io = io
...
class append_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'table', None, None, ), # 1
    (2, TType.STRUCT, 'append', (TAppend, TAppend.thrift_spec), None, ), # 2
  )

  def __init__(self, table=None, append=None,):
    self.table = table
    self.append = append
  ...
  def validate(self):
    ...
    if self.append is None:
      raise TProtocol.TProtocolException(message='Required field append is unset!')
    return
